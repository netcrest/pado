...
{
	jsonrpc, method, params(JsonLite.class), id, classname, replytopic, lang, daemon(boolean.class), agent(
			boolean.class), timeout(int.class), token(Object.class), username(String.class);
