package com.gemstone.gemfire.addon.command.task.data;
...
public class RegionAttributeInfo implements DataSerializable
{
	...
	private Properties attrProperties = new Properties();
	...
	public void fromData(DataInput in) throws IOException, ClassNotFoundException
	{
		...
		attrProperties = (Properties)DataSerializer.readObject(in);
	}
