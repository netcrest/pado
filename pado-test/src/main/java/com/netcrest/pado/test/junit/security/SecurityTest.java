...
/**
 * SecurityTest tests SSL/RSA + AES encryption. The grid must be configured
...
public class SecurityTest
{
	...
	{
		pados[0] = Pado.login("test", "netcrest", "dpark", "dpark".toCharArray());
	...
	{
		pados[1] = Pado.login("test", "netcrest", "foo", "foo".toCharArray(), "security/client2.keystore", "client2", "client2".toCharArray());
	...
	{
		pados[2] = Pado.login("test", "netcrest", "dpark2", "dpark2".toCharArray());
	...
	{
		pados[3] = Pado.login("test", "netcrest", "foo", "foo".toCharArray(), "security/client2.keystore", "client2", "client2".toCharArray());
