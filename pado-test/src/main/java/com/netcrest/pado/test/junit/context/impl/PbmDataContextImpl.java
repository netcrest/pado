...
public class PbmDataContextImpl implements IPbmDataContext, DataSerializable
{
	private static final long serialVersionUID = 1L;
	
	private IPbmDataInfo dataInfo = (IPbmDataInfo)ContextInfoFactory.createDataInfo();
	...
	@Override
	public IPbmDataInfo getDataInfo()
	{
		return dataInfo;
	}
