 ...
 */
package com.netcrest.pado.test.junit.context.data;
...
/**
 * @pado 3:2:0 -7052689070953905383:-5981796883872226852
 * @version 3 dpark:09/05/14.07.11.55.EDT
 * @padocodegen Updated Fri Sep 05 07:11:55 EDT 2014
 */
public enum PbmUserInfoKey implements KeyType {
	/**
	 * FUserId: <b>String</b>
	 */
	KFUserId("FUserId", String.class, false, true, "", 0),
	/**
	 * FLocation: <b>String</b>
	 */
	KFLocation("FLocation", String.class, false, true, "", 0),
	/**
	 * FOrg: <b>String</b>
	 */
	KFOrg("FOrg", String.class, false, true, "", 0),
	/**
	 * FIsOnBehalf: <b>Boolean</b>
	 */
	KFIsOnBehalf("FIsOnBehalf", Boolean.class, false, true, "", 0);

	private static final Object ID = new UUID(-7052689070953905383L,
			-5981796883872226852L);
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.test.junit.context.data.domain.PbmUserInfo");
	...
	private PbmUserInfoKey(String name, Class type, boolean isDeprecated,
