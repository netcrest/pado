...
public class PartitionedRegionBizImplLocal implements IPartitionedRegionBiz, IBizLocal
{
	@Resource
	...
	{
		// No need to go the grid to do a simple calculation 
		// like this. Do it locally.
		return x + y;
	}
