 ...
 * @version 1 dpark:02/28/14.18.24.49.EST
 * @padocodegen Updated Fri Feb 28 18:24:49 EST 2014
 */
public enum Account_v1 implements KeyType {
	/**
	 * AccountId: <b>String</b>
	 */
	KAccountId("AccountId", String.class, false, true, null, 0),
	/**
	 * AccountName: <b>String</b>
	 */
	KAccountName("AccountName", String.class, false, true, null, 0),
	/**
	 * LastName: <b>String</b>
	 */
	KLastName("LastName", String.class, false, true, null, 0),
	/**
	 * FirstName: <b>String</b>
	 */
	KFirstName("FirstName", String.class, false, true, null, 0),
	/**
	 * Address: <b>String</b>
	 */
	KAddress("Address", String.class, false, true, null, 0),
	/**
	 * BankId: <b>String</b>
	 */
	...
	private Account_v1(String name, Class type, boolean isDeprecated,
