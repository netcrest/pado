...
/**
 * @pado 9:8:1 758480909569445530:-7425363208675110297
 * @version 9 dpark:03/10/14.13.37.18.EDT
 * @padocodegen Updated Mon Mar 10 13:37:18 EDT 2014
 */
public enum Position_v9 implements KeyType {
	/**
	 * SecId: <b>String</b>
	 */
	KSecId("SecId", String.class, false, false, "", 0),
	/**
	 ...
	 */
	KExposure1("Exposure1", Double.class, false, true, "", 0),
	/**
	 * SettlementDate: <b>Date</b>
	 */
	KSettlementDate("SettlementDate", Date.class, false, true, "", 0),
	/**
	 * Exposure2: <b>Double</b>
	 */
	KExposure2("Exposure2", Double.class, false, true, "", 0),
	/**
	 * RiskFactor: <b>Double</b>
	 */
	KRiskFactor("RiskFactor", Double.class, false, true, "", 0); // 12
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.temporal.test.data.domain.Position");
	...
	private Position_v9(String name, Class type, boolean isDeprecated,
