...
/**
 * @pado 1:-1:0 758480909569445530:-7425363208675110297
 * @version 1 dpark:06/14/12.12.35.51.EDT
 * @padocodegen Updated Thu Jun 14 12:35:51 EDT 2012
 */
public enum Position_v1 implements KeyType {
	/**
	 * SecId: <b>String</b>
	 */
	 ...
	 * FiImntId: <b>Long</b>
	 */
	KFiImntId("FiImntId", Long.class, false, true, null, 0),
	/**
	 * Exposure1: <b>Double</b>
	 */
	KExposure1("Exposure1", Double.class, false, true, null, 0),
	/**
	 * MarketPlace: <b>Double</b>
	 */
	KMarketPlace("MarketPlace", Double.class, false, true, null, 0),
	/**
	...
	private Position_v1(String name, Class type, boolean isDeprecated,
