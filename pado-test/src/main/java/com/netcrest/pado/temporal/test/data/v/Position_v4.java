...
/**
 * @pado 4:-1:0 758480909569445530:-7425363208675110297
 * @version 4 dpark:06/14/12.12.37.43.EDT
 * @padocodegen Updated Thu Jun 14 12:37:43 EDT 2012
 */
public enum Position_v4 implements KeyType {
	/**
	 * SecId: <b>String</b>
	 */
	 ...
	 * @deprecated
	 */
	KFiImntId("FiImntId", Long.class, true, true, null, 0),
	/**
	 ...
	 * @deprecated
	 */
	KMarketPlace("MarketPlace", Double.class, true, true, null, 0),
	/**
	...
	private Position_v4(String name, Class type, boolean isDeprecated,
