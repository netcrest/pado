 ...
 * @version 1 dpark:02/28/14.18.24.57.EST
 * @padocodegen Updated Fri Feb 28 18:24:57 EST 2014
 */
public enum Bank_v1 implements KeyType
{
	/**
	 * BankId: <b>String</b>
	 */
	KBankId("BankId", String.class, false, true, null, 0),
	/**
	 * BankName: <b>String</b>
	 */
	KBankName("BankName", String.class, false, true, null, 0),
	/**
	 * RoutingNumber: <b>String</b>
	 */
	KRoutingNumber("RoutingNumber", String.class, false, true, null, 0),
	/**
	 * AccountNumber: <b>String</b>
	 */
	KAccountNumber("AccountNumber", String.class, false, true, null, 0),
	/**
	 * Type: <b>Byte</b>
	 */
	KType("Type", Byte.class, false, true, null, 0);

	private static final Object ID = new UUID(-4630091634444185827L, -5808792127484104036L);
	...
	static {
		try {
			domainClass = Class.forName("com.netcrest.pado.temporal.test.data.domain.Bank");
	...
	private Bank_v1(String name, Class type, boolean isDeprecated, boolean keyKeepSerialized, String path, int depth)
	{
	...
	static {
		...
		HashMap<String, KeyType> map = new HashMap<String, KeyType>(values.length + 1, 1f);
