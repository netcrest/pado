...
/**
 * @pado 8:5:0 758480909569445530:-7425363208675110297
 * @version 8 dpark:06/14/12.13.41.18.EDT
 * @padocodegen Updated Thu Jun 14 13:41:18 EDT 2012
 */
public enum Position_v8 implements KeyType {
	/**
	 * SecId: <b>String</b>
	 */
	 ...
	 * @deprecated
	 */
	KOriginalCost("OriginalCost", Double.class, true, true, null, 0),
	/**
	 * OriginalFace: <b>Double</b>
	 * 
	 * @deprecated
	 */
	KOriginalFace("OriginalFace", Double.class, true, true, null, 0),
	/**
	 ...
	 */
	KRiskFactor("RiskFactor", Double.class, false, true, null, 0); // 12
	...
	private Position_v8(String name, Class type, boolean isDeprecated,
