...
/**
 * @pado 1:-1:0 3694110525529999128:-5438543347399740348
 * @version 1 dpark:06/03/14.19.22.14.EDT
 * @padocodegen Updated Tue Jun 03 19:22:14 EDT 2014
 */
public enum AccountDetail_v1 implements KeyType {
	/**
	 ...
	 */
	KPortfolios("Portfolios", String.class, false, false, "portfolio?AccountId:${AccountId}", 4),
	/**
	...
	private AccountDetail_v1(String name, Class type, boolean isDeprecated,
