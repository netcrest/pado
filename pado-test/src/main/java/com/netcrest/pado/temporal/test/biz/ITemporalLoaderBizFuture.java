...
@BizFuture(bizInterface="com.netcrest.pado.temporal.test.biz.ITemporalLoaderBiz", localImpl="com.netcrest.pado.temporal.test.biz.impl.gemfire.TemporalLoaderBizFutureImplLocal")
public interface ITemporalLoaderBizFuture extends IBizFuture
{
	@BizMethod
