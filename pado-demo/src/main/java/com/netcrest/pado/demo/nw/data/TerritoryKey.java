 ...
 */
public enum TerritoryKey implements KeyType 
{
	/**
	 * <b>String</b>
	 */
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.demo.nw.data.domain.Territory");
	...
	private TerritoryKey(String name, Class<?> type, boolean isDeprecated,
