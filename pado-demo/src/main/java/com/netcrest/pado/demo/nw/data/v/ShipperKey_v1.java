...
/**
 * @pado 1:-1:1 3337468768778666259:-6497965664778677352
 * @version 1 pi:01/22/17.14.47.24.EST
 * @padocodegen Updated Sun Jan 22 14:47:24 EST 2017
 */
public enum ShipperKey_v1 implements KeyType 
{
	/**
	 * <b>String</b>
	 */
	KShipperId("ShipperId", String.class, false, true, "", 0),
	/**
	 * <b>String</b>
	 */
	...
	private static final Object ID = new UUID(3337468768778666259L, -6497965664778677352L);
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.demo.nw.data.v.domain.Shipper");
	...
	private ShipperKey_v1(String name, Class<?> type, boolean isDeprecated,
