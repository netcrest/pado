...
/**
 * @pado 1:-1:1 -2514377015914706570:-8773181112131739927
 * @version 1 pi:01/22/17.14.47.23.EST
 * @padocodegen Updated Sun Jan 22 14:47:23 EST 2017
 */
public enum CategoryKey_v1 implements KeyType 
{
	/**
	 * <b>String</b>
	 */
	 ...
	 * <b>String</b>
	 */
	KCategoryName("CategoryName", String.class, false, true, "", 0),
	/**
	 * <b>String</b>
	 */
	 ...
	 * <b>String</b>
	 */
	KPicture("Picture", String.class, false, true, "", 0);

	private static final Object ID = new UUID(-2514377015914706570L, -8773181112131739927L);
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.demo.nw.data.v.domain.Category");
	...
	private CategoryKey_v1(String name, Class<?> type, boolean isDeprecated,
