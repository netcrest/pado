 ...
 */
public enum CategoryKey implements KeyType 
{
	/**
	 * <b>String</b>
	 */
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.demo.nw.data.domain.Category");
	...
	private CategoryKey(String name, Class<?> type, boolean isDeprecated,
