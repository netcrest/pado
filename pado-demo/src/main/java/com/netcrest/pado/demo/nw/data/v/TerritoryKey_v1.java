...
/**
 * @pado 1:-1:1 -5278432198690975928:-7559089008036351501
 * @version 1 pi:01/22/17.14.47.24.EST
 * @padocodegen Updated Sun Jan 22 14:47:24 EST 2017
 */
public enum TerritoryKey_v1 implements KeyType 
{
	/**
	 * <b>String</b>
	 */
	KTerritoryId("TerritoryId", String.class, false, true, "", 0),
	/**
	 * <b>String</b>
	 */
	KTerritoryDescription("TerritoryDescription", String.class, false, true, "", 0),
	/**
	 * <b>String</b>
	 */
	KRegionId("RegionId", String.class, false, true, "", 0);

	private static final Object ID = new UUID(-5278432198690975928L, -7559089008036351501L);
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.demo.nw.data.v.domain.Territory");
	...
	private TerritoryKey_v1(String name, Class<?> type, boolean isDeprecated,
