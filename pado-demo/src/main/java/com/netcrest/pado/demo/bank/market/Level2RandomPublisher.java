 ...
 */
public class Level2RandomPublisher extends CacheBase
{
	...
	public Level2RandomPublisher() throws CacheException, IOException
	{
		init();
	...
	{
		Level2RandomPublisher feeder = new Level2RandomPublisher();
