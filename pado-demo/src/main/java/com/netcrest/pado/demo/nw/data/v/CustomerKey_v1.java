...
/**
 * @pado 1:-1:1 4658000967187779191:-6687318084260592893
 * @version 1 pi:01/22/17.14.47.23.EST
 * @padocodegen Updated Sun Jan 22 14:47:23 EST 2017
 */
public enum CustomerKey_v1 implements KeyType 
{
	/**
	 * <b>String</b>
	 */
	...
	private static final Object ID = new UUID(4658000967187779191L, -6687318084260592893L);
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.demo.nw.data.v.domain.Customer");
	...
	private CustomerKey_v1(String name, Class<?> type, boolean isDeprecated,
