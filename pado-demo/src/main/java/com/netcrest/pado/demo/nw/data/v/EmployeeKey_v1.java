 ...
 */
public enum EmployeeKey_v1 implements KeyType 
{
	/**
	 * <b>String</b>
	 */
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.demo.nw.data.v.domain.Employee");
	...
	private EmployeeKey_v1(String name, Class<?> type, boolean isDeprecated,
