 ...
 * @version 1 dpark:10/03/12.22.09.44.EDT
 * @padocodegen Updated Wed Oct 03 22:09:44 EDT 2012
 */
public enum Level2KeyType implements KeyType {
	/**
	 * SeqNum: <b>Integer</b>
	 */
	...
	private Level2KeyType(String name, Class type, boolean isDeprecated,
