 ...
 * @version 1 dpark:10/04/12.13.17.33.EDT
 * @padocodegen Updated Thu Oct 04 13:17:33 EDT 2012
 */
public enum OrderInfoKeyType implements KeyType {
	/**
	...
	private OrderInfoKeyType(String name, Class type, boolean isDeprecated,
