...
/**
 * @pado 1:-1:1 8889746137261493302:-5358460206205505104
 * @version 1 pi:01/22/17.14.47.24.EST
 * @padocodegen Updated Sun Jan 22 14:47:24 EST 2017
 */
public enum EmployeeTerritoryKey_v1 implements KeyType 
{
	/**
	 * <b>String</b>
	 */
	...
	private static final Object ID = new UUID(8889746137261493302L, -5358460206205505104L);
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.demo.nw.data.v.domain.EmployeeTerritory");
	...
	private EmployeeTerritoryKey_v1(String name, Class<?> type, boolean isDeprecated,
