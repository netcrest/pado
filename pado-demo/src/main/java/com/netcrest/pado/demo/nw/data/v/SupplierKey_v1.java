...
/**
 * @pado 1:-1:1 -8762813722905524656:-8739281664557036572
 * @version 1 pi:01/22/17.14.47.24.EST
 * @padocodegen Updated Sun Jan 22 14:47:24 EST 2017
 */
public enum SupplierKey_v1 implements KeyType 
{
	/**
	 * <b>String</b>
	 */
	 ...
	 * <b>String</b>
	 */
	KCompanyName("CompanyName", String.class, false, true, "", 0),
	/**
	 * <b>String</b>
	 */
	KContactName("ContactName", String.class, false, true, "", 0),
	/**
	 * <b>String</b>
	 */
	KContactTitle("ContactTitle", String.class, false, true, "", 0),
	/**
	 * <b>String</b>
	 */
	 ...
	 * <b>String</b>
	 */
	KPhone("Phone", String.class, false, true, "", 0),
	/**
	 * <b>String</b>
	 */
	KFax("Fax", String.class, false, true, "", 0),
	/**
	 * <b>String</b>
	 */
	KHomePage("HomePage", String.class, false, true, "", 0);

	private static final Object ID = new UUID(-8762813722905524656L, -8739281664557036572L);
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.demo.nw.data.v.domain.Supplier");
	...
	private SupplierKey_v1(String name, Class<?> type, boolean isDeprecated,
