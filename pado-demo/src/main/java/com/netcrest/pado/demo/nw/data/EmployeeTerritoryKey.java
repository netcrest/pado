 ...
 */
public enum EmployeeTerritoryKey implements KeyType 
{
	/**
	 * <b>String</b>
	 */
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.demo.nw.data.domain.EmployeeTerritory");
	...
	private EmployeeTerritoryKey(String name, Class<?> type, boolean isDeprecated,
