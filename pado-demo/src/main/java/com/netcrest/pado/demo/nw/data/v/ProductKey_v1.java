...
/**
 * @pado 1:-1:1 4198593991916799986:-6494784077188357931
 * @version 1 pi:01/22/17.14.47.24.EST
 * @padocodegen Updated Sun Jan 22 14:47:24 EST 2017
 */
public enum ProductKey_v1 implements KeyType 
{
	/**
	 * <b>String</b>
	 */
	 ...
	 * <b>String</b>
	 */
	KProductName("ProductName", String.class, false, true, "", 0),
	/**
	 * <b>String</b>
	 */
	KSupplierId("SupplierId", String.class, false, true, "", 0),
	/**
	 * <b>String</b>
	 */
	KCategoryId("CategoryId", String.class, false, true, "", 0),
	/**
	 * <b>double</b>
	 */
	KQuantityPerUnit("QuantityPerUnit", double.class, false, true, "", 0),
	/**
	 * <b>double</b>
	 */
	 ...
	 * <b>String</b>
	 */
	KUnitsInStock("UnitsInStock", String.class, false, true, "", 0),
	/**
	 * <b>String</b>
	 */
	KUnitsOnOrder("UnitsOnOrder", String.class, false, true, "", 0),
	/**
	 * <b>String</b>
	 */
	KReorderLevel("ReorderLevel", String.class, false, true, "", 0),
	/**
	 * <b>String</b>
	 */
	KDiscontinued("Discontinued", String.class, false, true, "", 0);

	private static final Object ID = new UUID(4198593991916799986L, -6494784077188357931L);
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.demo.nw.data.v.domain.Product");
	...
	private ProductKey_v1(String name, Class<?> type, boolean isDeprecated,
