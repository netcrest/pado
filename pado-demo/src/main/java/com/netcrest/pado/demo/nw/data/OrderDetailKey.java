 ...
 */
public enum OrderDetailKey implements KeyType 
{
	/**
	 * <b>String</b>
	 */
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.demo.nw.data.domain.OrderDetail");
	...
	private OrderDetailKey(String name, Class<?> type, boolean isDeprecated,
