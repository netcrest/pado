 ...
 */
public enum OrderKey_v1 implements KeyType 
{
	/**
	 * <b>String</b>
	 */
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.demo.nw.data.v.domain.Order");
	...
	private OrderKey_v1(String name, Class<?> type, boolean isDeprecated,
