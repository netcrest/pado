 ...
 */
public enum SupplierKey implements KeyType 
{
	/**
	 * <b>String</b>
	 */
	...
	static {
		try {
			domainClass = Class
					.forName("com.netcrest.pado.demo.nw.data.domain.Supplier");
	...
	private SupplierKey(String name, Class<?> type, boolean isDeprecated,
