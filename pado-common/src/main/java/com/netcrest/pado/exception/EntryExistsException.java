...
/**
 * EntryExistsException is thrown if a target grid is not available.
 * 
 * @author dpark
 * 
 */
public class EntryExistsException extends PadoException
{
	private static final long serialVersionUID = 1L;

	/**
	 * Constructs a new EntryExistsException exception with
	...
	/**
	 * Constructs a new EntryExistsException exception with the specified detail
	 * message.
	 * <p>
	...
	/**
	 * Constructs a new EntryExistsException exception with the specified
