 ...
 */
@BizClass
public interface IIndexMatrixBizLink<T> extends IBiz
{
	/**
	 * Query type. Default is PQL.
	 * 
	 * @author dpark
	 * 
	 */
	...
	{
		/**
		 * OQL is a query language native to the underlying data grid product
		 * such as GemFire. Query statements always begin with "select".
		 */
		OQL,

		/**
		 * PQL is a hybrid query language that currently supports OQL and
		 * Lucene. PQL is default.
		 * <ul>
		 * <li>To execute Lucene: &lt;grid-path&gt;?[attribute-name:]&lt;search
		 * string&gt;</li>
		 * <li>To execute OQL: &lt;grid-path&gt;.attribute-name=value AND|OR..</li>
		 * </ul>
		 */
		PQL
	}
