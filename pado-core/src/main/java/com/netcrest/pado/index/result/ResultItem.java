...
public class ResultItem <T extends Object> implements DataSerializable, Comparable<ResultItem> {
	
		private static final long serialVersionUID = 122343255L;
		...
		public void setItem(T resultId) {
			this.item = resultId;
		}
