...
public class ClassFinder
{
	 ...
	 * getClasses(String jarPath, String packageName) if the classes are in a
	 * jar file.
	 * 
	 * @param packageName
	 *            The base package
	 ...
	 * @param packageName
	 *            The package name.
	 * @return Returns all classes that are in the specified jar and package
	 *         name.
	 * @throws ClassNotFoundException
	 *             Thrown if unable to load a class
	 * @throws IOException
	 ...
	 * @param packageName
	 *            The package name.
	 * @return Returns all names of classes that are defined in the specified
	 *         jar and package name.
	 * @throws IOException
	 *             Thrown if error occurs while reading the jar file
	 */
	 ...
	 * 
	 * @param jarPath
	 *            The absolute or relative jar path. It returns null if jarPath
	 *            is null.
	...
	/**
	 * Returns all classes that are in the specified jar using the specified
	 * class loader.
	 * 
	 * @param jarPath
	 *            The absolute or relative jar path.
	 * @param classLoader
	 *            The class loader to load the classes found in the jar.
	 * @return Returns all classes that are in the specified jar. It returns
	 *         null if jarPath or classLoader is null.
	 * @throws ClassNotFoundException
	 *             Thrown if unable to load a class
	 * @throws IOException
	 *             Thrown if error occurs while reading the jar file
	 */
	@SuppressWarnings("rawtypes")
	public static Class[] getAllClasses(String jarPath, ClassLoader classLoader) throws ClassNotFoundException,
			IOException
	{
