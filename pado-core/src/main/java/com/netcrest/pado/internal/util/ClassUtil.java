...
public class ClassUtil
{
	...
	{
		return c.isPrimitive() || c.isArray() || c.isEnum() || c == Integer.class || c == Short.class
				|| c == Long.class || c == Byte.class || c == Character.class || c == Float.class || c == Double.class
	 ...
	 * returns an empty string. For enum, it returns the first enum value if
	 * any. For all others, it instantiates the class by invoking the default
	 * constructor.
	 * 
	 * @param clazz
