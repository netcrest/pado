...
/**
 * SchemaGenerator is a client program that generates schema files for all data
 * files found in the specified data directory. The generated schema files may
 * need to be manually edited to include the correct grid paths and primary
 * keys.
 * 
 * @author dpark
 *
