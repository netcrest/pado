...
public class ImportScheduler
{
	...
	void logDisclaimer()
	{
		...
		Logger.log("ImportScheduler started. All import results are logged in this file. For GemFire specifics, please the corresponding '-gemfire.log' file");
	}
	...
	private static void usage()
	{
		...
		writeLine();
		writeLine("      -sched  Runs the scheduler which periodically import data into the grid.");
		...
		writeLine();
		writeLine("   Note that the default exits immediately. It does not execute the");
	...
	public static void main(String[] args)
	{
		...
		ImportScheduler client = new ImportScheduler();
		try {
