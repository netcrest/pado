...
public class pwd implements ICommand
{
	...
	public void help()
	{
		PadoShell.println("pwd [-?]");
		PadoShell.println("   Display the current path (full path).");
	}

	@Override 
	public String getShortDescription()
	{
		return "Display the current path (full path).";
	}
	...
	{
		PadoShell.println(padoShell.getCurrentPath());
	}
}
