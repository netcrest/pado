...
public final class BizGridQueryService
{
	...
	{
		if (querySvc == null) {
			synchronized (BizGridQueryService.class) {
				if (querySvc == null)
					querySvc = new BizGridQueryServiceImpl();
			}
		}
		return querySvc;
	}
	...
	{
		synchronized (BizGridQueryService.class) {
			querySvc = new BizGridQueryServiceImpl(pool, regionService);
		}
		return querySvc;
	}
