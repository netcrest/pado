...
public class MemberFilter extends IndexMatrixFilter implements DataSerializable
{
	...
	{
		return "MemberFilter [targetSize=" + targetSize + ", value=" + value + "]";
	}
	...
	public void fromData(DataInput input) throws IOException, ClassNotFoundException
	{
		...
		targetSize = DataSerializer.readPrimitiveInt(input);
	...
	{
		super.toData(output);
		DataSerializer.writePrimitiveInt(targetSize, output);
