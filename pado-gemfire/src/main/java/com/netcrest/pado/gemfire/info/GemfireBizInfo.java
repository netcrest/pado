...
public class GemfireBizInfo extends BizInfo implements DataSerializable
{
	private static final long serialVersionUID = 1L;
	
	public GemfireBizInfo()
	{
	}

	public GemfireBizInfo(String bizIntefaceName)
	{
	...
	{
		bizIntefaceName = DataSerializer.readString(input);
	...
	{
		DataSerializer.writeString(bizIntefaceName, output);
