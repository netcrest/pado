 ...
 * initialization information to the application during the cache 
 * startup period. It allows the application to register classes 
 * that implement CacheInitializable in the cache.xml file. It
 * instantiate the registered classes and invokes CacheInitializable.postInit()
 * after a delay period specified by the <code>"initDelay"</code> parameter.
 * For example, the following configures the add-on CacheInitializer and 
 * multi-router components, which get invoked after 5000 milliseconds. 
 * The default delay is 20,000 milliseconds (or 20 seconds).
 * <p>
 * <pre>
 *    &lt;region name="__init"&gt;
      &lt;region-attributes data-policy="empty"&gt;
         &lt;cache-listener&gt;
            ...
            &lt;parameter name="cacheserver"&gt;
               ...
               &lt;/declarable&gt;
            &lt;/parameter&gt;
            &lt;parameter name="addons"&gt;
               &lt;declarable&gt;
                  &lt;class-name&gt;com.netcrest.pado.gemfire.AddonInitializer&lt;/class-name&gt;
                  &lt;parameter name="multirouter.enabled"&gt;
                     &lt;string&gt;true&lt;/string&gt;
                  &lt;/parameter&gt;
               &lt;/declarable&gt;
            &lt;/parameter&gt;
