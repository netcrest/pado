...
public class UserInfoImpl implements IUserInfo, DataSerializable
{
	private static final long serialVersionUID = 1L;
	
	HashMap<String, Object> userInfoMap = new HashMap(5);
	...
	{
		userInfoMap = DataSerializer.readHashMap(input);
	}
	...
	{
		DataSerializer.writeHashMap(userInfoMap, output);
	}
}
