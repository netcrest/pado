...
public class SimpleUserContextImpl implements ISimpleUserContext, DataSerializable
{
	private static final long serialVersionUID = 1L;
	
	private Object token;
	private String username;
	private IUserInfo userInfo = ContextInfoFactory.createUserInfo();
	private transient IGridService gridService;

	public SimpleUserContextImpl()
	{
	}
	...
	public void fromData(DataInput input) throws IOException, ClassNotFoundException
	{
		...
		username = DataSerializerEx.readUTF(input);
	...
	public void toData(DataOutput output) throws IOException
	{
		...
		DataSerializerEx.writeUTF(username, output);
