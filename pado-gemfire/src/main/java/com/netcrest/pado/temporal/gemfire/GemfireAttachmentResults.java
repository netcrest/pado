...
public class GemfireAttachmentResults<V>extends AttachmentResults<V>
{
	private static final long serialVersionUID = 1L;
	
	public GemfireAttachmentResults()
	{}
	...
	public void fromData(DataInput input) throws IOException, ClassNotFoundException
	{
		...
		attachmentValues = DataSerializer.readObject(input);
	}
	...
	public void toData(DataOutput output) throws IOException
	{
		...
		DataSerializer.writeObject(attachmentValues, output);
	}
