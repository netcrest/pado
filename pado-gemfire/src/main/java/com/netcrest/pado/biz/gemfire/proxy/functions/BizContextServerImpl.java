...
public class BizContextServerImpl implements IBizContextServer
{	
	private static final long serialVersionUID = 1L;
	
	BizContextClientImpl bizContextClient;
	Context context;
	
	public BizContextServerImpl(BizContextClientImpl bizContextClient, FunctionContext fc, Object[] additionalArgs, Object[] transientData)
	{
		this.bizContextClient = bizContextClient;
		this.context = new Context(bizContextClient, fc, additionalArgs, transientData);
	}
	
	public BizContextClientImpl getBizContextClient()
	{
		return bizContextClient;
	}
	
	@Override
	public IUserContext getUserContext()
	{
		if (bizContextClient == null) {
			return null;
		}
		return bizContextClient.getUserContext();
	}
	...
	public IDataContext getDataContext()
	{
		...
		return bizContextClient.getDataContext();
	}
