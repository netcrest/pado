...
# ------ | ------------------ | ----- | ----- | ----- | ----------------- | ----------------- | ------------------ | ----------- | -----------
   1       localhost            20201   10201   30201   server.properties   server_gateway.xml  pado.properties      pado.xml      true
   2       localhost            20202   10202   30202   server.properties   server.xml          pado.properties      pado.xml      true
