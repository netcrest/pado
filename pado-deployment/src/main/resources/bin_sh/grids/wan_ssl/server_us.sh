...
# ------ | ------------------ | ----- | ----- | ----- | ----------------- | ----------------- | ------------------ | ----------- | -----------
   1       localhost            20001   10001   30001   server.properties   server_gateway.xml  pado.properties      pado.xml      true
   2       localhost            20002   10002   30002   server.properties   server_gateway.xml  pado.properties      pado.xml      true
   3       localhost            20003   10003   30003   server.properties   server.xml          pado.properties      pado.xml      true
