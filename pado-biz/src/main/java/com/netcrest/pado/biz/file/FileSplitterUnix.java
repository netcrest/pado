...
/**
 * FileSplitterUnix splits a large file into smaller files by an output file
 * size or a number of output file by executing the Unix command "split".
 * 
 * @author dpark
 * 
 */
public class FileSplitterUnix
{
	private static void usage()
	{
		System.out.println();
		System.out.println("FileSplitterUnix splits a file into smaller files using");
		System.out.println("the Unix 'split' command.");
		System.out.println();
		System.out.println("Usage:");
		System.out.println("   FileSplitterUnix <input file path>");
		...
		System.out.println("   Default: FileSplitterUnix -l 10000 -dir .");
		System.out.println();
	...
	public static void main(String[] args) throws Exception
	{
		...
		if (outputFileCount == -1) {
			FileUtilUnix.splitByOutputFileSize(inputFile, outputDir, outputFilePrefix, lineCountPerSplit);
		} else {
			FileUtilUnix.splitByOutputFileCount(inputFile, outputDir, outputFilePrefix, outputFileCount);
		}
